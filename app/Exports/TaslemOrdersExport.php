...
class TaslemOrdersExport implements FromCollection, WithEvents, WithHeadings, WithColumnWidths, WithTitle, WithMapping
{
    public $data;
    ...
    public function map($order): array
    {
        return [
            ...
            $order->service_provider->raft_name_only,
