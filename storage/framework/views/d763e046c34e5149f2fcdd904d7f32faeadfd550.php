...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form id="add_edit_form" method="post" action="<?php echo e(route('delivery.add_report')); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="row">
                    <div class="col-md-12">
                        <div class="mb-3">
...
<?php $__env->startSection('scripts'); ?>
    <script>
        ...
        $('.submit_btn').click(function (e) {
            ...
            postData(new FormData($('#add_edit_form').get(0)), '<?php echo e(route('delivery.add_report')); ?>');
        });
...
<?php echo $__env->make('CP.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ahmedsal/workspace/tslem/resources/views/CP/delivery/report_add_form.blade.php ENDPATH**/ ?>