                    ...
                    <form class="row gx-3 gy-2 align-items-center mb-4 mb-lg-0">
                        ...
                        <div class="col-lg-2">
                            ...
                            <select class="form-control" id="service_provider_id" name="service_provider_id">
                                <option value="">اختر...</option>
                                <?php $__currentLoopData = $service_providers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $services_provider): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <script>
        ...
        $(function () {
            $('#items_table').DataTable({
                ...
                "serverSide": true,
                ajax: {
                    url: '<?php echo e(route('consulting_office.list')); ?>',
                    type: 'GET',
                    "data": function (d) {
        ...
        function accept(id) {
            ...
            $.ajax({
                url: '<?php echo e(route('consulting_office.accept')); ?>',
                data: {
                    id: id
                },
                type: "POST",
        ...
        function reject(id) {
            ...
            $.ajax({
                url: '<?php echo e(route('consulting_office.reject')); ?>',
                data: {
                    id: id
                },
                type: "POST",
...
<?php echo $__env->make('CP.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ahmedsal/workspace/tslem/resources/views/CP/consulting_office/orders.blade.php ENDPATH**/ ?>