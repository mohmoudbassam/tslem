                    ...
                    <div class="btn-group" role="group">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="btnGroupDrop1" style="">
                            <li><a class="dropdown-item font-size-18 mb-2 mt-2"
                                   href="<?php echo e(route('services_providers.create_order')); ?>"><i class="dripicons-plus"></i>إنشاء
                                    طلب </a></li>
                        </ul>
                    </div>
                </h4>
...
<?php $__env->startSection('scripts'); ?>
    <script>
        ...
        function accept(id) {
            ...
            $.ajax({
                url: '<?php echo e(route('design_office.accept')); ?>',
                data: {
                    id: id
                },
                type: "POST",
        ...
        function reject(id) {
            ...
            $.ajax({
                url: '<?php echo e(route('design_office.reject')); ?>',
                data: {
                    id: id
                },
                type: "POST",
