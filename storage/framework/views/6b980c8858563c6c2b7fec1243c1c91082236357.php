...
<head>
    ...
    <!-- CSS only -->
    <link rel="stylesheet" href="<?php echo e(url('assets/css/bootstrap.rtl.5.min.css')); ?>"/>
            ...
            <nav class="navbar navbar-expand-lg navbar-light pt-5">
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <form class="d-row">
                            <a role="button" href="<?php echo e(route('login_page')); ?>" class="btn btn-md btn-primary" type="submit">
                                تسجيل الدخول
                            </a>

                            <a role="button" href="<?php echo e(route('register', ['type' => 'service_provider'])); ?>" class="btn btn-md btn-outline-primary" type="submit">
                                التسجيل
                            </a>
...
<?php /**PATH /Users/ahmedsal/workspace/tslem/resources/views/public.blade.php ENDPATH**/ ?>