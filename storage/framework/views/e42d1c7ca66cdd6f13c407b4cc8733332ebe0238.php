...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form id="add_edit_form" method="post" action="<?php echo e(route('service.store')); ?>">
                <?php echo csrf_field(); ?>
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="unit" value="<?php echo e(old('name')); ?>" id="unit"
                                   placeholder="الوحدة">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-control" id="specialties_id" name="specialties_id">
                                ...
                                <?php $__currentLoopData = $specialties; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($s->id); ?>"><?php echo e($s->name_ar); ?></option>
...
<?php $__env->startSection('scripts'); ?>
    <script>
        ...
        $('.submit_btn').click(function (e) {
            ...
            postData(formData, '<?php echo e(route('service.store')); ?>');
...
<?php echo $__env->make('CP.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ahmedsal/workspace/tslem/resources/views/CP/SystemConfig/services_add.blade.php ENDPATH**/ ?>