    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18"><a class="btn btn-primary" href="<?php echo e(route('const.add')); ?>"><i class="dripicons-user p-2"></i>إضافة ثابت</a></h4>

                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">إدارة ثوابت النظام</a></li>
    ...
    <script>
        ...
        $(function () {
            $('#items_table').DataTable({
                ...
                "serverSide": true,
                ajax: {
                    url: '<?php echo e(route('const.list')); ?>',
                    type: 'GET',
                    "data": function (d) {
                        d.name = $('#name').val();
        ...
        function delete_const(id, url, callback = null) {
            Swal.fire({
                title: 'هل انت متاكد من حذف الثابت؟',
                text: "",
                type: 'warning',
...
<?php echo $__env->make('CP.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/ahmedsal/workspace/tslem/resources/views/CP/SystemConfig/const.blade.php ENDPATH**/ ?>