    ...
    <div class="card-body">
        <form id="add_edit_form" method="post" action="<?php echo e(route('users.add_edit')); ?>" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="type" name="type">
                            ...
                            <option <?php if($record->type =="service_provider"): ?> selected <?php endif; ?>
                            ...
                            <option <?php if($record->type =="consulting_office"): ?> selected <?php endif; ?>
                            ...
                            <option <?php if($record->type =="raft_company"): ?> selected <?php endif; ?> value="raft_company">شركة طوافة
                            </option>
                            <option <?php if($record->type =="taslem_maintenance"): ?> selected <?php endif; ?> value="taslem_maintenance">صيانة تسليم
                            </option>
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        <label class="form-label" for="name"> <?php if($record->type == "Kdana" || $record->type == "Delivery" || $record->type == "Sharer"): ?> اسم الشخصي المسؤول <?php else: ?> الاسم<?php endif; ?><span
                                class="text-danger required-mark">*</span></label>
                        <input type="text" class="form-control" name="name" value="<?php echo e(old('name')); ?>" id="name"
                            placeholder="<?php if($record->type == "Kdana" || $record->type == "Delivery" || $record->type == "Sharer"): ?> اسم الشخصي المسؤول <?php else: ?> الاسم<?php endif; ?>">
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        <label class="form-label" for="company_name">اسم الشركة / المؤسسة<span
                                class="text-danger required-mark">*</span></label>
                        <input type="text" class="form-control" id="company_name" value="<?php echo e(old('company_name')); ?>"
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        <label class="form-label" for="phone">رقم الجوال<span
                                class="text-danger required-mark">*</span></label>
                        <input type="text" onkeypress="return /[0-9]/i.test(event.key)" value="<?php echo e(old('phone')); ?>"
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <select class="form-control" id="city" name="city">
                            ...
                            <option value="<?php echo e($cityItem); ?>" <?php if($cityItem==$record->city || $cityItem == old('city')): ?>
                                selected <?php endif; ?>><?php echo e($cityItem); ?></option>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="file" class="form-control" value="<?php echo e(old('commercial_file')); ?>" id="commercial_file"
                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control commercial_file_end_date"
                            value="<?php echo e(old('commercial_file_end_date')); ?>" id="commercial_end_date"
            ...
            <?php if($record->commissioner_id_photox): ?>
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
            ...
            <?php if($record->commissioner_photos): ?>
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
            ...
            <?php if($record->nomination_letter): ?>
            <div class="row">
                <div class="col-md-6">
                    <div class="mb-3">
...
<script>
    let commercial_file_end_date = "<?php echo e(old('commercial_file_end_date')); ?>";
    let rating_certificate_end_date = "<?php echo e(old('rating_certificate_end_date')); ?>";
    let profession_license_end_date = "<?php echo e(old('profession_license_end_date')); ?>";
    let business_license_end_date = "<?php echo e(old('business_license_end_date')); ?>";
    let social_insurance_certificate_end_date = "<?php echo e(old('social_insurance_certificate_end_date')); ?>";
    let date_of_zakat_end_date = "<?php echo e(old('date_of_zakat_end_date')); ?>";
    let saudization_certificate_end_date = "<?php echo e(old('saudization_certificate_end_date')); ?>";
    let chamber_of_commerce_certificate_end_date = "<?php echo e(old('chamber_of_commerce_certificate_end_date')); ?>";


    <?php $__currentLoopData = array_keys(get_user_column_file($type)); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $_col): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    file_input_register('#<?php echo e($_col); ?>');
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
