...
<head>
    ...
    <!-- CSS only -->
    <link rel="stylesheet" href="assets/css/bootstrap.rtl.5.min.css">
        ...
        <div class="header">
            <nav class="navbar navbar-expand-lg navbar-light pt-5">
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <form class="d-flex">
                            <button class="btn btn-outline-main mx-2" type="submit">التسجيل</button>
            ...
            <section class="header-desc w-full text-center">
                ...
                <div class="header-info">
                    <h1 class="text-white">منصة الخدمات الالكترونية <br> لمركز الخدمات الشامل</h1>
                    <p class="text-white">منصة واحدة لجميع القطاعات العاملة في الحج <br>
    ...
    <section class="about" id="about">
        <div class="row container" style="margin-left: auto !important;margin-right: auto !important;">
            <div class="col-md-6 text-start">
                ...
                <p class="header-text">مركز ريادي متكامل لتقديم الخدمات اللازمة لمزودي خدمات الحج :
                    تسهيل الاجراءات من خلال العمل تحت مظلة واحدة لكافة الجهات. سيحقق هذا المركز الارتقاء</p>

                <div class="services">
                    <div class="">
                        <h3>
                            <svg xmlns="http://www.w3.org/2000/svg" width="21.371" height="21.374" viewBox="0 0 21.371 21.374">
                                <path id="Path_4513" data-name="Path 4513" d="M57.361,389.732a2.276,2.276,0,0,0-2.214-.593l-.565.151-2.555.685-13.669,3.663a2.268,2.268,0,0,0-1.653,1.767,2.06,2.06,0,0,0-.044.431,2.394,2.394,0,0,0,.714,1.677.677.677,0,0,0,.134.1l7.157,4.191a1.721,1.721,0,0,1,.615.613l4.092,6.919a2.182,2.182,0,0,0,1.708,1.09c.05,0,.1,0,.149,0a2.391,2.391,0,0,0,.6-.079,2.275,2.275,0,0,0,1.62-1.622l1.78-6.647.685-2.555,2.032-7.584A2.271,2.271,0,0,0,57.361,389.732Z" transform="translate(58.033 410.434) rotate(180)" fill="#b4815a"/>
                            </svg>
                            خدمة مميزة
                        </h3>
                        <p class="header-text">نص تجريبي للتصمييم يتم استبداله لاحقا نص تجريبي للتصمييم يتم استبداله لاحقا</p>
                    </div>
                    <div class="">
                        <h3>
                            <svg xmlns="http://www.w3.org/2000/svg" width="21.371" height="21.374" viewBox="0 0 21.371 21.374">
            ...
            <h1 class="col-md-6">
                <img src="./assets/img/header-217.jpeg" class="img-thumbnail">
            </h1>
        </div>
    </section>
        ...
        <div class="states-main">
            <div class="container row" style="margin-left: auto !important;margin-right: auto !important;">
                <div class="text-center col text-center">
                    ...
                    <h3 class="text-white mt-2">+1550</h3>
    ...
    <section id="info">
        <div class="row container" style="margin-left: auto !important;margin-right: auto !important;">
            <div class="col-md-6 my-4">
                <img src="./assets/img/تسليم 2.png">
                <p class="header-text my-2">هذا النص هو مثال لنص يمكن أن يستبدل في نفس المساحة</p>
