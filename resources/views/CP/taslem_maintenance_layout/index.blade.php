    ...
    <div class="row align-items-center">
        ...
        <div class="col-lg-auto mt-3 mt-lg-0">
            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-end">
                <h4 class="mb-sm-0 font-size-18 me-2"><a class="btn btn-primary"
                                                         href="{{route('taslem_maintenance.sessions.add_form')}}"><i
                            class="fa fa-plus pe-2"></i>إضافة موعد</a></h4>
                @if(!$isToday)
                    <h4 class="mb-sm-0 font-size-18"><a class="btn btn-primary"
                                                        href="{{route('taslem_maintenance.sessions.toDaySessions')}}"><i
                                class="fa fa-clock pe-2"></i>مواعيد اليوم</a></h4>
                @else
                    <h4 class="mb-sm-0 font-size-18"><a class="btn btn-primary"
                                                        href="{{route('taslem_maintenance.index')}}"><i
                                class="fa fa-clock pe-2"></i>جميع المواعيد</a></h4>
                    <h4 class="mb-sm-0 font-size-18 m-lg-2"><a class="btn btn-primary" onclick="exportPdf()"
                                                               href="javascript:;"><i class="fa fa-file-pdf pe-2"></i>تصدير</a>
                    </h4>
                        ...
                        <form class="row gx-3 gy-2 align-items-center mb-4 mb-lg-0 " id="form_data">
                            ...
                            <div class="col-sm-auto ms-auto" style="margin-top:1.9rem;">
                                ...
                                <button type="button" class="btn btn-secondary reset_btn px-4"><i
                                        class="far fa-times me-1"></i>إلغاء
                                </button>
                            </div>
                        </form>
                    </div>
        ...
        <div class="modal fade" id="page_modal" tabindex="-1" role="dialog" data-toggle="modal" data-backdrop="static"
             data-keyboard="false" aria-labelledby="view-user-files-modal-title" aria-hidden="true">
        ...
        @section('scripts')
            <script>
                ...
                function exportPdf() {
                    var Url = "{{route('taslem_maintenance.sessions.export')}}";
