            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form id="add_edit_form" method="post" action="{{route('users.add_edit')}}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" id="type" name="type">
                                        ...
                                        value="service_provider">شركات حجاج الداخل
                                        </option>
                                        ...
                                        value="consulting_office">مكتب استشاري
                                        </option>
                                        <option @if($record->type =="contractor") selected @endif value="contractor">مقاول
                                        </option>
                                        <option @if($record->type =="raft_company") selected @endif value="raft_company">شركة
                                            طوافة
                                        </option>
                                        <option @if($record->type =="taslem_maintenance") selected
                                                @endif value="taslem_maintenance">صيانة تسليم
                                        </option>
                            ...
                            @if($record->type == "Delivery" and 1 == 2)
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label" for="delivery_type">التخصص<span
                            ...
                            @if($record->type == "Kdana" and 1 == 2)
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label" for="kdana_type">التخصص<span
                                                class="text-danger required-mark">*</span></label>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label class="form-label"
                                           for="name"> @if($record->type == "Kdana" || $record->type == "Delivery" || $record->type == "Sharer")
                                            اسم الشخصي المسؤول @else الاسم@endif<span
                                            class="text-danger required-mark">*</span></label>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control" id="city" name="city">
                                            @foreach(citiesList() as $cityItem)
                                                <option value="{{ $cityItem }}"
                                                        @if($cityItem==$record->city || $cityItem == old('city'))
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control business_license_end_date"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control date_of_zakat_end_date"
                                               id="date_of_zakat_end_date"
                        ...
                        @if($record->wage_protection_certificate)
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label class="form-label" for="wage_protection_certificate">شهادة حماية الأجور
                                            (PDF)</label>
                ...
                <div class="card-footer">
                    <div class="d-flex flex-wrap gap-3">
                        <button type="button" class="btn btn-lg btn-primary submit_btn" form="add_edit_form">إنشاء</button>
                    </div>
                </div>
            </div>
        </div>
