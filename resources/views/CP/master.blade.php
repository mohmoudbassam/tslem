        ...
        <div class="page-content">
            <div class="container-fluid">
                ...
                @if(auth()->user()->verified == 0 &&  !auth()->user()->isAdmin() )
                    <div class="alert alert-danger p-2 font-14"> لم يتم اعتماد حسابك بعد</div>
                @endif
...
<!-- datepicker js -->
<script src="{{ asset('assets/libs/flatpickr/flatpickr.min.js?v=2') }}"></script>
    ...
    $(() => {
        $('.show-modal')
            .each((i, e) => {
                ...
                if (href !== voidHref && href !== '#') {
                    e.attr('href', voidHref);
                    e.attr('original-href', href);
                    e.click((event) => {
                        event.preventDefault()

                        showModal(href, null, '#page_modal_master');
                    })
                }
            })
    })
