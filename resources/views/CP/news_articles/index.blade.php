@extends('CP.master')
@section('title')
    {{\App\Models\NewsArticle::trans('plural')}}
@endsection
@section('content')
    <!-- region: breadcrumb -->
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">
                    <a class="btn btn-primary" href="{{route('news_articles.add')}}">
                        <i class="dripicons-news_article p-2"></i>
                        {{\App\Models\NewsArticle::crudTrans('create')}}
                    </a>
                </h4>
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a
                                href="javascript: void(0);">{{\App\Models\NewsArticle::crudTrans('index')}}</a></li>
            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    ...
                    <table class="table align-middle datatable dt-responsive table-check nowrap dataTable no-footer"
                        ...
                        <thead>
                        @foreach(\App\Models\NewsArticle::getIndexColumns(true) as $field)
                            <th>{{$field}}</th>
                        @endforeach
    ...
    <script>
        ...
        $(function () {
            $('#items_table').DataTable({
                ...
                columns: {!! \App\Models\NewsArticle::getDatatableColumns(true, true) !!}
            })
                .order([0, 'desc']);
        ...
        function delete_model(id, url, callback = null) {
            Swal.fire({
                title: '{{\App\Models\NewsArticle::crudTrans('delete_confirm')}}',
                text: "",
                type: 'warning',
