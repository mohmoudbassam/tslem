...
@section('content')
            ...
            <div class="col-xl-4 col-md-6">
                <div class="card card-h-100 card-chart card-chart__filled card-chart__filled--blue">
                    <div class="card-body px-2">
                        ...
                        <a href="{{route('kdana.orders')}}?params=designe_office_orders">عرض الطلبات</a>
                    </div>
                </div>
            </div>
            <div class="col-xl-4 col-md-6">
                <div class="card card-h-100 card-chart card-chart__filled card-chart__filled--blue">
                    <div class="card-body px-2">
                        ...
                        <a href="{{route('kdana.orders')}}?params=tasleem">عرض الطلبات</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-4 col-md-6">
                <div class="card card-h-100 card-chart card-chart__filled card-chart__filled--blue">
                    <div class="card-body px-2">
                        ...
                        <h3>عدد رخص الجاهزية الصادرة</h3>
                        <p>{{$license_number}}   رخصة </p>
                        <a href="{{route('kdana.show_license')}}">عرض الرخص</a>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-6" >
                        <div class="card card-h-100 card-chart card-chart__filled card-chart__filled--brown">
                            <div class="card-body px-2">
                                ...
                                <a href="{{route('kdana.show_users')}}?params=raft_in">عرض الشركات</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6" >
                        <div class="card card-h-100 card-chart card-chart__filled card-chart__filled--lighbrown">
                            <div class="card-body px-2">
                                ...
                                <a href="{{route('kdana.show_users')}}?params=raft_out">عرض الشركات</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-6" >
                        <div class="card card-h-100 card-chart card-chart__filled card-chart__filled--lighbrown">
                            <div class="card-body px-2">
                                ...
                                <a href="{{route('kdana.show_users')}}?params=design_office">عرض المكاتب</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6" >
                        <div class="card card-h-100 card-chart card-chart__filled card-chart__filled--brown">
                            <div class="card-body px-2">
                                ...
                                <a href="{{route('kdana.show_users')}}?params=contractor">عرض المقاولين</a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal fade" id="page_modal" tabindex="-1" role="dialog" aria-labelledby="view-user-files-modal-title" aria-hidden="true">
