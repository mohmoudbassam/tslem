            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">
                    <div class="btn-group" role="group">
                        <a href="javascript: void(0);" onclick="showModal('{{route('media.form')}}')"   class="btn btn-primary dropdown-toggle">
                            انشاء ميديا <i class="fa fa-clipboard-check"></i>
                        </a>
...
@section('scripts')
    ...
    function delete_media(id, url, callback = null) {
        Swal.fire({
            title: 'هل انت متاكد من حذف الميديا؟',
            text: "",
            type: 'warning',
