...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form id="add_edit_form" method="post" action="{{route('contractor.update_report')}}"
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div>
                            <div class="mb-3">
                                ...
                                <input class="form-control" name="title" type="text" placeholder="العنوان"
                                       value="{{$report->title}}" id="title">
                    ...
                    <div class="col-lg-12">
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" rows="5" name="description" placeholder="الوصف"
                                      id="description">{{$report->description}}</textarea>
            ...
            <div class="d-flex flex-wrap gap-3">
                <button type="button" class="btn btn-lg btn-primary submit_btn">نعديل  التقرير</button>
            </div>
        </div>
    </div>
