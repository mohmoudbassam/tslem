    ...
    <div class="card">
        ...
        <div class="card-body">
                    ...
                    <div class="col-lg-6">
                        <div>
                            <div class="mb-3">
                                ...
                                <input class="form-control" name="title" type="text" value="{{$order->title}}" placeholder="العنوان" id="title">
                        ...
                        <div>
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" name="description"   placeholder="الوصف" id="description">{{$order->description}}</textarea>
                    ...
                    <div class="col-lg-6">
                        <div class="mt-3 mt-lg-0">
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="date" name="date" value="{{$order->date}}" id="date">
            ...
            <div class="d-flex flex-wrap gap-3">
                <button type="button" class="btn btn-lg btn-primary submit_btn">تعديل الطلب</button>
            </div>
        </div>
