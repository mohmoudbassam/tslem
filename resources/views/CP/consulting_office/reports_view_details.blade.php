                                ...
                                >
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            <p class="details_p">
                                                <span class="bold"> رقم الطلب :</span>{{$order->id}}</p>
                                        </div>

                                        <div class="col-md-6 mb-3">
                                            <p class="details_p">
                                                <span class="bold"> التاريخ:</span>{{$order->created_at}}
                                            </p>
                                        </div>

                                        <div class="col-md-6 mb-3">
                                            <p class="details_p">
                                                <span class="bold"> العنوان :</span>{{$order->title}}</p>
                                        </div>

                                        <div class="col-md-6 mb-3">
                                            <p class="details_p">
                                                <span class="bold">اسم مقدم الخدمة :</span>
                                                {{$order->service_provider->name}}</p>
                                        </div>

                                        <div class="col-md-6 mb-3">
                                            <p class="details_p">
                                                <span class="bold"> التفاصيل :
                                                </span>{{$order->description}}</p>
                                        </div>

                                        <div class="col-md-6 mb-3">
                                            <p class="details_p">
                                                <span class="bold"> اسم مكتب التصميم :
