                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row  mb-4 gx-0">
                                ...
                                <div class="col-md-6">
                                    <p class="mb-0 space-nowrap p-3 border-bottom border-top border-start border-end fs-7"><span class="bold">  تاريخ الإنشاء :</span> {{$order->created_at->format("Y-m-d")}}</p>
                                </div>

                                <div class="col-md-6">
                                    <p class="mb-0  p-3 border-end border-top border-bottom fs-7"><span class="bold">  رقم الطلب : </span>{{$order->identifier}}</p>
                                </div>

                                <div class="col-md-6">
                                    <p class="mb-0  p-3 border-start border-bottom border-end fs-7"><span
                                            class="bold">مركز الخدمة :</span> {{ (isset($order->service_provider)) ? $order->service_provider->company_name : ''}}</p>
                                </div>
                                <div class="col-md-6">
                                    <p class="mb-0  p-3 border-end border-bottom fs-7"><span
                                            class="bold"> اسم مكتب التصميم :  </span>{{ (isset($order->designer)) ? $order->designer->company_name : ''}}</p>
                                </div>
                                <div class="col-md-6">
                                    <p class="mb-0 border-bottom border-end border-start p-3 fs-7"><span
                                            class="bold">المقاول :  </span>{{ ($order->contractor) ? $order->contractor->company_name : '' }}</p>
                                </div>
                                <div class="col-md-6 ">
                                    <p class="mb-0 border-bottom border-end p-3 fs-7"><span
