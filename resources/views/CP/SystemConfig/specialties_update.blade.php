...
@section('content')
            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a href="javascript: void(0);">تعديل تخصص</a></li>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form id="add_edit_form" method="post" action="{{route('specialties.update')}}">
                @csrf
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="name_ar" value="{{ $specialties->name_ar }}" id="name_ar"
                                   placeholder="الإسم">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="name_en" value="{{ $specialties->name_en}}" id="name_en"
                ...
                <input type="hidden" name="id" value="{{ $specialties->id }}">
            </form>
...
@section('scripts')
    <script>
        ...
        $('.submit_btn').click(function (e) {
            ...
            postData(formData, '{{route('specialties.update')}}');
